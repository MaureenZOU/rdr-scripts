...
class PaperDatabase:
    def __init__(self, output_dir: str = "dataset"):
        ...
        self.filename = os.path.join(output_dir, "siggraph25.json")
...
def process_siggraph_papers():
    input_file = "venue/assets/siggraph2025.json"
    ...
    print(f"[INFO] Processing {total_papers} SIGGRAPH 2025 papers")
