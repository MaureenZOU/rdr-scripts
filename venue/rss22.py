...
def scrape_individual_paper(session, paper_url):
    ...
    """
    paper_url = paper_url.replace("program", "2022/program")
...
def scrape_rss_papers():
    """
    Scrapes the RSS 2022 papers and saves them to a JSON database.
    """    
    db = PaperDatabase()
...
if __name__ == "__main__":
    ...
    PAPERS_URL = "https://roboticsconference.org/2022/program/papers/"
    scrape_rss_papers()