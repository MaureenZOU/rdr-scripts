...
class PaperDatabase:
    def __init__(self, output_dir: str = "dataset"):
        ...
        self.filename = os.path.join(output_dir, "rss23.json")
...
def scrape_rss_papers():
    """
    Scrapes the RSS 2023 papers and saves them to a JSON database.
    """    
    db = PaperDatabase()
...
if __name__ == "__main__":
    ...
    PAPERS_URL = "https://roboticsconference.org/2023/program/papers/"
    scrape_rss_papers()