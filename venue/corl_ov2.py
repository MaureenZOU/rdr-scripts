...
class PaperDatabase:
    def __init__(self, output_dir: str = "dataset"):
        ...
        self.filename = os.path.join(output_dir, "corl24.json")
...
def scrape_corl_papers(username: str):
    """
    ...
    try:
        ...
        vg = client.get_group(venue_id)
        submission_name = vg.content['submission_name']['value']  # e.g., "Submission"
